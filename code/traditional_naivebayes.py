...
file=open("/root/finaloutputs/2000000_rows.csv","r")
X= []
label=[]
for line in file:
    Features=[]
...
#STEP 4:Train The classifier on training data. Training the model here.
my_classifier2.fit(X_train,Y_train)
#STEP 5:Using Predict Method to classify the Testing DataSet. Running the model on test dataset of Features.
